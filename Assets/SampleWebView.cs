...
public class SampleWebView : MonoBehaviour
{
    ...
    //    Rect rect = new Rect(x * ratio, (Screen.height - 25) * ratio, 40 * ratio, 40 * ratio);
    ...
    //    GUI.TextField(new Rect(x*ratio, (Screen.height - 25) * ratio, 180 * ratio, 40 * ratio), "" + webViewObject.Progress());
    //    x += 190;
